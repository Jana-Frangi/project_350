...
class IthonArenaClient:
    ...
    def _draw_game(self, screen, fsm, fmd, flg, chat_input):
        ...
        # Show the last part of long input text 
    ...
    def run(self):
        ...
        while running:
            ...
            for event in pygame.event.get():
                ...
                # All the original event handling for each phase 
